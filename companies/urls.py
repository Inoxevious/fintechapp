...
urlpatterns=[
    ...
    path('retention_analytics/', views.ApplicationAnalyticsResultsView.as_view(), name='retention_analytics'),
    path('behavioral_analytics/', views.ApplicationAnalyticsResultsView.as_view(), name='behavioral_analytics'),
