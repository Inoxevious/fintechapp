...
def get_data(csv_file):
    ...
    for row in reader:
        if rownum  ==  0:
            ...
            AMT_REQ_CREDIT_BUREAU_HOUR =row[116],AMT_REQ_CREDIT_BUREAU_DAY =row[117],AMT_REQ_CREDIT_BUREAU_WEEK =row[118],AMT_REQ_CREDIT_BUREAU_MON =row[119],AMT_REQ_CREDIT_BUREAU_QRT =row[120],AMT_REQ_CREDIT_BUREAU_YEAR =row[121]
)
            the_row.save()
