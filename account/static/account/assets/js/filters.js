        ...
        $.each(result["data"], function (a, b) {
            ...
            $.each(b, function (d, c) {
                ...
                row = "<tr> <td>" + c.cust_id + "</td>" +
                    ...
                    "<td>" + "</td>" +
                    "<td>" + "</td></tr>"
                $("#behaviora_listing").append(row);
            });
        });

        // populate retention_listing data
        $.each(result["data"], function (a, b) {
            ...
            $.each(b, function (d, c) {
                ...
                row = "<tr> <td>" + c.cust_id + "</td>" +
                    ...
                    "<td>" + "</td>" +
                    "<td>" + "</td>" +
                    "<td style='background-color:" + c.income_color + "'>" + c.income_probability * 100 + "</td>" +
                    "<td style='background-color:" + c.income_color + "'>" + c.loan_amount + "</td>" +
                    // "<td style='background-color:" + c.application_color + "'>" + c.application_text + "</td>" +
                    "<td>" + "</td></tr>"
                $("#retention_listing").append(row);
            });
        });
    }
    else {
        // if no result found for the given filter, then display no result
        console.log("b data no data")
